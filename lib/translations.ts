...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    steps: {
      ...
      step7: {
        ...
        consent: "Consent",
        consentConsent: "I consent to share this clinical logic for medical research and training purposes.",
    ...
    ui: {
      ...
      thankYouMessage: "Your clinical logic has been successfully submitted and will be used to improve healthcare research and patient care.",
    ...
    about: {
      ...
      subtitle: "Join the forefront of healthcare innovation. Your clinical expertise is the key to developing more accurate, ethical, and effective solutions for preventive medicine.",
      mission: "Our Mission",
      missionText: "HDMS bridges the gap between real-world medical expertise and research datasets, enabling the development of more accurate and clinically relevant patient care protocols.",
      collaboration: "Strategic Collaboration",
      collaborationText: "We partner with healthcare professionals worldwide to collect validated clinical knowledge that improves healthcare solutions.",
      dataEthics: "Data Ethics & Privacy",
      dataEthicsText: "All data is collected with explicit consent, anonymized, and used ethically for research and training purposes only.",
      benefits: "Benefits for Contributors",
      benefitsList: [
        "Dataset collaboration recognition",
        "Access to aggregated insights",
        "Contribution to healthcare advancement",
        "Professional development opportunities",
      ],
      contact: "Get Involved",
      contactText: "Join our community of healthcare professionals contributing to the future of medicine.",
      impactStats: [
      ...
      process: {
        ...
        3: "Your contributions help develop clinically accurate patient care protocols.",
        4: "Global Impact",
        5: "Your expertise enables solutions that improve healthcare outcomes worldwide."
      },
      benefitsSection: {
      ...
      cta: {
        ...
        description: "Join hundreds of medical professionals who are already contributing to the future of healthcare. Your expertise can help save lives and improve healthcare outcomes globally.",
    ...
    dashboard: {
      ...
      public: "Public",
      anonymous: "Anonymous",
      riskAssessment: "Clinical Risk Assessment",
      highRisk: "High Risk",
      mediumRisk: "Medium Risk",
      lowRisk: "Low Risk",
      keyFactors: "Key Factors:",
      syntheticPatientProfile: "Research Patient Profile",
  ...
  bn: {
    ...
    placeholders: {
      ...
      subtypesTitle: "উপপ্রকারসমূহ",
      keyFeatures: "মূল বৈশিষ্ট্য",
      additionalNotes: "অতিরিক্ত নোট",
      familyHistory: "পারিবারিক ইতিহাস",
      polygenicAutosomal: "পলিজেনিক/অটোসোমাল",
      howItAffects: "কিভাবে এটি প্রভাবিত করে",
      labsVitalsSigns: "ল্যাব, ভাইটাল, লক্ষণ",
      duration: "সময়কাল",
      progressionTriggers: "অগ্রগতির ট্রিগার",
      commonSymptoms: "সাধারণ লক্ষণ",
      subtleSigns: "সূক্ষ্ম লক্ষণ",
      ...
      frequency: "যেমন, 60%",
      firstLineSecondLine: "প্রথম লাইন/দ্বিতীয় লাইন",
      metformin: "মেটফরমিন",
      dosageExample: "ডোজের উদাহরণ",
      whenToStartStop: "কখন শুরু/বন্ধ করতে হবে",
      recommendations: "সুপারিশ",
      pediatricDiff: "শিশুদের পার্থক্য",
      adultDiff: "প্রাপ্তবয়স্কদের পার্থক্য",
      chestPain: "বুকে ব্যথা",
      immediateAction: "তাত্ক্ষণিক পদক্ষেপ",
      labExample: "ল্যাবের উদাহরণ",
      rangeExample: "পরিসরের উদাহরণ",
      criticalExample: "সমালোচনামূলক উদাহরণ",
      followUpExample: "ফলো-আপের উদাহরণ",
      bloodGlucoseWeight: "রক্তের গ্লুকোজ, ওজন",
      urbanSpecific: "শহুরে নির্দিষ্ট",
      ruralSpecific: "গ্রামীণ নির্দিষ্ট",
      renalFailure: "রেনাল ব্যর্থতা",
      type1Diabetes: "টাইপ 1 ডায়াবেটিস",
      autoantibodyTesting: "অটোঅ্যান্টিবডি পরীক্ষা",
      culturalInfluence: "সাংস্কৃতিক প্রভাব",
      socioeconomicFactors: "সামাজিক-অর্থনৈতিক কারণ",
      otherRelevant: "অন্যান্য প্রাসঙ্গিক",
      doctorName: "ডাক্তারের নাম",
      yourInstitution: "আপনার প্রতিষ্ঠান",
      yourSpecialty: "আপনার বিশেষজ্ঞতা",
      cityCountry: "শহর, দেশ",
      lineOfTreatment: "চিকিৎসার লাইন",
      ...
      criticalValues: "সমালোচনামূলক মান",
      followUpFrequency: "ফলো-আপের ফ্রিকোয়েন্সি",
      keyMetricsToMonitor: "নিরীক্ষণ করার মূল মেট্রিক্স",
